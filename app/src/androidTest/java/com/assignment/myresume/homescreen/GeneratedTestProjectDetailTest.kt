...
class GeneratedTestProjectDetailTest {
    ...
    fun projectScreenDetailTest() {
        ...
        val textView2 = onView(
            allOf(
                withId(R.id.tvEmployer), withText("Employer: Cannot disclose"),
                childAtPosition(
                    childAtPosition(
                        IsInstanceOf.instanceOf(android.widget.ScrollView::class.java),
                        0
        ...
        val textView3 = onView(
            allOf(
                withId(R.id.tvTechnology), withText("Technology: Kotlin"),
                childAtPosition(
                    childAtPosition(
                        IsInstanceOf.instanceOf(android.widget.ScrollView::class.java),
                        0
        ...
        val textView4 = onView(
            allOf(
                withId(R.id.tvDomain), withText("Domain: Banking"),
                childAtPosition(
                    childAtPosition(
                        IsInstanceOf.instanceOf(android.widget.ScrollView::class.java),
                        0
